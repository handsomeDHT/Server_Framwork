...
#ifndef SERVER_FRAMWORK_CRYPTO_UTIL_H
#define SERVER_FRAMWORK_CRYPTO_UTIL_H
...
public:
    ...
    static int32_t
    Crypto(const EVP_CIPHER *cipher, bool enc, const void *key, const void *iv, const void *in, int32_t in_len,
...
#endif //SERVER_FRAMWORK_CRYPTO_UTIL_H
