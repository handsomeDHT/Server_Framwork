...
#ifndef SERVER_FRAMWORK_WS_SESSION_H
#define SERVER_FRAMWORK_WS_SESSION_H
...
extern dht::ConfigVar<uint32_t>::ptr g_websocket_message_max_size;
...
#endif //SERVER_FRAMWORK_WS_SESSION_H
