...
public:
    ...
    virtual int32_t handle(dht::http::HttpRequest::ptr request
            ...
            , dht::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (dht::http::HttpRequest::ptr request
            , dht::http::HttpResponse::ptr response
            , dht::http::HttpSession::ptr session)> callback;
...
#endif //SERVER_FRAMWORK_SERVLET_H
